        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredCourses.map((course) => (
            <div
              ...
              className="group bg-slate-50 rounded-3xl p-5 shadow-sm hover:shadow-xl border border-slate-200/70 hover:border-[#00B060]/50 transition-all duration-300 flex flex-col justify-between cursor-pointer hover:-translate-y-1"
            >
              <div>
                ...
                <h3 className="text-lg font-bold text-[#052e7f] mb-2 group-hover:text-[#00B060] transition-colors line-clamp-1">
                  {course.title}
                </h3>
              ...
              <div className="pt-3 border-t border-slate-200/80 flex items-center justify-between">
                ...
                <span className="inline-flex items-center gap-1 text-xs font-bold text-[#052e7f] group-hover:text-[#00B060] transition-colors">
