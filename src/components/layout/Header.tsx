      ...
      <div className="bg-white/95 backdrop-blur-md rounded-full p-[6px] sm:p-[8px] flex items-center justify-between shadow-[0_4px_25px_rgba(11,79,156,0.08)] border border-white/80 pointer-events-auto transition-all">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden xl:flex items-center gap-1.5 pl-2 border-l border-slate-200">
            ...
            >
              <svg className="w-3.5 h-3.5 fill-[#0080FF] group-hover:fill-[#FF0000] group-hover:scale-115 transition-all" viewBox="0 0 24 24">
            ...
            >
              <svg className="w-3.5 h-3.5 fill-[#0080FF] group-hover:fill-[#E4405F] group-hover:scale-115 transition-all" viewBox="0 0 24 24">
        ...
        {/* RIGHT: Live Clock Guarulhos & WhatsApp Button */}
