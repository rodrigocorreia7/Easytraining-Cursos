        ...
        <div className="bg-white/95 backdrop-blur-md rounded-full px-3 sm:px-4 py-1.5 sm:py-2 flex items-center justify-between shadow-[0_4px_25px_rgba(11,79,156,0.08)] border border-white/80 pointer-events-auto transition-all w-full max-w-full box-border">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <div className="hidden xl:flex items-center gap-1.5 pl-2 border-l border-slate-200">
              ...
              <a
                href={(config.social as any).tiktok || "https://www.tiktok.com/@easytrainingcursos"}
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-full bg-slate-50 hover:bg-slate-200 flex items-center justify-center transition-all group shadow-2xs border border-slate-100"
                aria-label="TikTok EasyTraining"
              >
                <svg className="w-3.5 h-3.5 fill-slate-900 group-hover:scale-115 transition-transform" viewBox="0 0 24 24">
                  <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 3 15.68 6.34 6.34 0 0 0 9.34 22a6.34 6.34 0 0 0 6.33-6.33V9.05a8.16 8.16 0 0 0 4.67 1.47V7.07a4.85 4.85 0 0 1-.75-.38z"/>
                </svg>
              </a>
            </div>
          </div>
          ...
          >
            ...
            <div className="mt-3 pt-2.5 border-t border-slate-100 flex items-center justify-between text-[10px] text-slate-500">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>•</span>
                <a href={(config.social as any).tiktok || "https://www.tiktok.com/@easytrainingcursos"} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-slate-900 font-medium">
                  TikTok
                </a>
                <span>•</span>
