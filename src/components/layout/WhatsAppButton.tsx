...
export const WhatsAppFloatingButton: React.FC = () => {
  const whatsappUrl = `https://wa.me/${siteConfig.whatsappClean}?text=${encodeURIComponent('Ol�! Acessei o site da EasyTraining e gostaria de tirar d�vidas sobre os cursos.')}`;
  ...
  return (
    <aside aria-label="Atendimento via WhatsApp" className="fixed bottom-6 right-6 z-40">
      <a
        ...
        className="group relative flex items-center gap-2.5 px-4 py-3 bg-[#075E54] hover:bg-[#054c44] text-white rounded-full shadow-2xl transition-all duration-300 hover:scale-105 active:scale-95 border-2 border-white/40 focus:outline-none focus:ring-4 focus:ring-emerald-500/40"
      >
