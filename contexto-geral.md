...
- **Variáveis de Ambiente Necessárias (Vercel & `.env.local`)**:
  ...
  - `FIREBASE_CLIENT_EMAIL` (Secret - Firebase Admin)
  - `FIREBASE_PRIVATE_KEY` (Secret - Firebase Admin)
  - `FIREBASE_STORAGE_BUCKET` (Server-side / uploads, opcional quando as imagens ficam inline no Firestore)
